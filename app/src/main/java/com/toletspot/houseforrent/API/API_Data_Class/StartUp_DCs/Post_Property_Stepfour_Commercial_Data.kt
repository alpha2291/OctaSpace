...
@Serializable
data class Post_Property_Stepfour_Commercial_Dataold(
    @SerialName("area_dimensions")
    val area_dimensions: List<AreaDimensionX>,
    ...
    val floor_details: List<FloorDetailX>,
    @SerialName("optional")
    val optional: List<OptionalX>,

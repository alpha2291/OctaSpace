...
fun AboutUsScreen(navHostController : NavHostController)
{
    ...
    val url = MainActivity.getAboutUsUrl()
        .plus("?device_id="+ constants.GetDevice_UDID(constants.activity))
        .plus("&group_id=").plus("66")
        ...
        .plus("&is_develop_or_prod=").plus(DevelopmentMode)
        .plus("&user_id=").plus(AppPreferences.getUserId())

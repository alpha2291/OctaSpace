...
val Gold80 = Color(0xFFE8D9A8)
val WarmGrey80 = Color(0xFFD8D2C4)
val Bronze80 = Color(0xFFE0C97F)

val Gold40 = Color(0xFFA08200)
...
val newPurpleGradientBorder  =  listOf(Color(0xffF0E4BC) , Color(0xffE6C96A), Color(0xffCFB14E))
...
val newLightBlue = Color(0xffF7F0DC)
val newBlack = Color(0xff1A1A1A)
val newRed = Color(0xffE54C3C)
val new5757 = Color(0xff575757)
